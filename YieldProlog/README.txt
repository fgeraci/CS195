Welcome to Yield Prolog.  See:
http://yieldprolog.sourceforge.net/

For the changes, see the news for each release at:
http://sourceforge.net/news/?group_id=176875

CONTENTS:

* bin folder
Contains executables, including:
...
* doc folder
Contains a snapshot of the Yield Prolog web site including the tutorial.
Open index.html in your browser.

* source folder
Contains a folder for the source of each supported platform.
The examples subfolder for each platform contains the YPShell, tutorial examples and
benchmarks code.
